...
import { LcCard, LcLoadingState, LcErrorState, PageTransition } from '../../components/lc';
...
export const HomePage: React.FC = () => {
  ...
  if (loading) return <LcLoadingState label="Loading your home..." />;
  if (error || !data) {
    return <LcErrorState message="We couldn't load your home summary." onRetry={loadHome} />;
  }
