...
const FeatureBlock: React.FC<{ title: string; description: string }> = ({ title, description }) => (
  <Box id="features" sx={{ mb: 6 }}>
    ...
    >
      <Typography sx={{ fontFamily: landingFonts.sans, color: landing.gray400, fontSize: '0.9rem' }}>
        Illustration here
      </Typography>
    </Box>
  </Box>
