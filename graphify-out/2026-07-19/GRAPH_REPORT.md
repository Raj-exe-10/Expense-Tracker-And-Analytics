...
## Corpus Check
- 384 files · ~200,058 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2967 nodes · 4886 edges · 287 communities (234 shown, 53 thin omitted)
...
## Communities (287 total, 53 thin omitted)
...
Cohesion: 0.07
Nodes (29): API Changelog, API Endpoints, API Versioning, Authentication, Base URL & Versioning, Base URLs, Error Codes, Error Handling (+21 more)
